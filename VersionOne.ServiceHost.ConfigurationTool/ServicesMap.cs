...
namespace VersionOne.ServiceHost.ConfigurationTool {
    ...
    public class ServicesMap {
        ...
        public static readonly ServicesMap QualityCenterService = new ServicesMap(
            typeof(QCServiceEntity),
            "VersionOne.ServiceHost.QualityCenterServices.QualityCenterHostedService",
            "VersionOne.ServiceHost.QualityCenterServices.QualityCenterReaderService+IntervalSync"
            );
